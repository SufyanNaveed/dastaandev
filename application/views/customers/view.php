                    ...
                    <div class="col-md-8">
                        ...
                        <div class="">
                            ...
                            <div id="accordionWrapa1" role="tablist" aria-multiselectable="true">
                                ...
                                <div id="heading2" class="card-header">
                                    <a data-toggle="collapse" data-parent="#accordionWrapa1" href="#accordion2"
                                       ...
                                       class="card-title lead collapsed">
                                        <i class="fa fa-plus-circle"></i> <?php echo $this->lang->line('Address') ?> <?php echo $this->lang->line('Details') ?>
                                    </a>
                                </div>
                                ...
                                <h5 class="bg-blue bg-lighten-4  p-1 mt-2"><?php echo $this->lang->line('Wallet') . ' ' . $this->lang->line('Balance') . ': ' . amountFormat($details['balance']) ?></h5>

                                <hr>
                                <h5><?php echo $this->lang->line('Summary') ?></h5>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <span class="badge tag-default tag-pill bg-success float-xs-right"><?php echo amountFormat($money['credit']) ?></span>
                                        <?php echo $this->lang->line('Income') ?>
                                    </li>
                                    <li class="list-group-item">
                                        <span class="badge tag-default tag-pill bg-danger float-xs-right"><?php echo amountFormat($money['debit']) ?></span>
                                        <?php echo $this->lang->line('Expenses') ?>
                                    </li>

                                    <li class="list-group-item">
                                        <span class="badge tag-default tag-pill bg-pink float-xs-right"><?php echo amountFormat($due['total'] - $due['pamnt']) ?></span>
                                        <?php echo $this->lang->line('Total Due') ?>
                                    </li>
                                    <li class="list-group-item">
                                        <span class="badge tag-default tag-pill bg-blue float-xs-right"><?php echo amountFormat($due['discount']) ?></span>
                                ...
                                <div id="heading6" class="card-header bg-grey bg-lighten-4 p-1 mt-2">
                                    <a data-toggle="collapse" href="#accordion6"
