<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5><?php echo $this->lang->line('Customer') . ' ' . $this->lang->line('Credit Notes') ?> <a
                        href="<?php echo base_url('stockreturn/create_note') ?>"
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <table id="invoices_c" class="table table-striped table-bordered zero-configuration">
                    <thead>
                    <tr>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var table = $('#invoices_c').DataTable({
                "processing": true,
                "serverSide": true,
                responsive: true,
                "order": [],
