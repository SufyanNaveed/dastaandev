    ...
    <table>
        <tr>
            ...
            <td class="myw">
                <table class="top_sum">
                    <tr>
                        <td colspan="1" class="t_center"><h2><?php echo $this->lang->line('Delivery Note') ?></h2>
                            <br><br></td>
                    </tr>
                    <tr>
                        <td><?php echo $this->lang->line('Delivery Order') ?>:</td>
                        <td><?php echo prefix(3) . '_DO ' . $invoice['tid'] ?></td>
                    </tr>
                    <tr>
