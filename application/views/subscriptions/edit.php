                            ...
                            <div class="col-sm-6 cmp-pnl">
                                <div class="inner-cmp-pnl">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6"><label for="reccur"
                                                                     class="caption"><?php echo $this->lang->line('Next Payment After') ?></label>
                                            <select
                                                    name="reccur"
                                                    class="selectpicker form-control">
                                                <option value="7 day">7 <?php echo $this->lang->line('Days') ?></option>
                                                <option value="14 day">
                                                    14 <?php echo $this->lang->line('Days') ?></option>
                                                <option value="28 day">
                                                    28 <?php echo $this->lang->line('Days') ?></option>
                                                <option value="30 day">
                                                    30 <?php echo $this->lang->line('Days') ?></option>
                                                <option value="45 day">
                                                    45 <?php echo $this->lang->line('Days') ?></option>
                                                <option value="2 month">
                                                    2 <?php echo $this->lang->line('Months') ?></option>

                                                <option value="3 month">
                                                    3 <?php echo $this->lang->line('Months') ?></option>
                                                <option value="6 month">
                                                    6 <?php echo $this->lang->line('Months') ?></option>
                                                <option value="9 month">
                                                    9 <?php echo $this->lang->line('Months') ?></option>
                                                <option value="1 year">
                                                    1 <?php echo $this->lang->line('Year') ?></option>
                        ...
                        <input type="hidden" class="pdIn" name="pid[]" id="pid-' . $i . '" value="' . $row['pid'] . '">
                             <input type="hidden" name="unit[]" id="unit-' . $i . '" value="' . $row['unit'] . '"> <input type="hidden" name="hsn[]" id="unit-' . $i . '" value="' . $row['code'] . '">
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    ...
                                    <td align="left" colspan="2"><span
                                                class="currenty lightMode"><?php echo $this->config->item('currency'); ?></span>
                                        <span id="discs" class="lightMode"><?php echo $invoice['discount'] ?></span>
                                    </td>
                                </tr>
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    ...
                                    <td align="left" colspan="2"><input type="text" class="form-control shipVal"
                                        ...
                                        <span id="ship_final"><?= $invoice['ship_tax'] ?> </span> )
                                    </td>
                                </tr>
