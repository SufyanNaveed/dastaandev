                ...
                <div class="row">
                    ...
                    <div class="">
                        ...
                        if ($invoice['status'] != 'canceled') { ?>
                            ...
                            <a href="<?= base_url() . 'customers/editStView?id=' . $invoice['iid']; ?>" class="btn btn-warning mb-1"><i
                        ...
                        <ul class="px-0 list-unstyled">
                            ...
                            <li class="text-bold-800"><a
                                        href="<?php echo base_url('customers/view?id=' . $invoice['cid']) ?>"><strong
                                            class="invoice_a"><?php echo $invoice['name'] . '</strong></a></li><li>' . $this->lang->line('Phone') . ': ' . $invoice['phone'] . '</li>';
...
<th scope="row">' . $c . '</th>
                            ...
                            <td></td>
                                        ...
                                        echo '<tr><td colspan=5>' . $row['product_descr'] . '</td></tr>';
                                        $c++;
                                    } ?>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-xs-right"> <?php echo amountExchange($invoice['total'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
                                    <tr>
