                            ...
                            <div class="btn-group ">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item"
                                       href="<?php echo 'printquote?id=' . $invoice['iid']; ?>"><?php echo $this->lang->line('Print') ?></a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
                                       href="<?php echo 'printquote?id=' . $invoice['iid']; ?>&d=1"><?php echo $this->lang->line('PDF Download') ?></a>
