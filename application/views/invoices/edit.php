                    ...
                    <div class="row">
                        ...
                        <div id="saman-row">
                            <table class="table-responsive tfr my_stripe">
                                ...
                                <tr class="item_header bg-gradient-directional-light-blue white">
                                    <th width="30%"
                        ...
                        <input type="hidden" class="pdIn" name="pid[]" id="pid-' . $i . '" value="' . $row['pid'] . '">
                             <input type="hidden" name="unit[]" id="unit-' . $i . '" value="' . $row['unit'] . '">
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                 ...
                                 <tr class="sub_c" style="display: table-row;">
                                <td colspan="6" align="right">
                                   <strong> <?php echo  $this->lang->line('Extra').' '.$this->lang->line('Discount') ?></strong></td>
                                <td align="left" colspan="2">   <input type="text" class="form-control form-control-sm discVal"
                                       onkeypress="return isNumber(event)"
                                       placeholder="Value"
                                       name="disc_val" autocomplete="off"
                                       onkeyup="billUpyog()" value="<?= amountExchange_s($invoice['discount_rate'], $invoice['multi'], $this->aauth->get_user()->loc); ?>">
                                 <input type="hidden"
