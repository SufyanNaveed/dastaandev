                ...
                <div id="invoice-customer-details ">
                    ...
                    <div class="row pt-2">
                        ...
                        <div class="col-md-3 col-sm-12 text-xs-center text-md-left">
                            ...
                            echo '<p><span class="text-muted">' . $this->lang->line('Invoice Date') . ' :</span> ' . dateformat($invoice['invoicedate']) . '</p> <p><span class="text-muted">' . $date_text . ' :</span> ' . dateformat($invoice['invoiceduedate']) . '</p>  <p><span class="text-muted">' . $this->lang->line('Terms') . ' :</span> ' . $invoice['termtit'] . '</p> <p><span class="text-muted">Trial Date:</span> ' . dateformat($nap['trial_date']) . '</p> <p><span class="text-muted">Delivery Date:</span> ' . dateformat($nap['d_date']) . '</p>';
                            ?>
                        </div>
                    </div>
                </div>
...
<th scope="row">' . $c . '</th>
                            ...
                            <td>' . amountExchange($row['subtotal'], $invoice['multi'], $invoice['loc']) . '</td>
                                        ...
                                        echo '<tr><td colspan=7>' . $row['product_des'] . '</td></tr>';                  if (CUSTOM) {
                                        $p_custom_fields = $this->custom->view_fields_data($row['pid'], 4, 1);
