 ...
 <div class="m-1"><div class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" <?php if(CUSTOM) echo 'checked=""'; ?> name="customCheck" id="customCheck">
                    <label class="custom-control-label" for="customCheck"> <?php echo $this->lang->line('Enable') ?>  <?php echo $this->lang->line('Custom') ?>  <?php echo $this->lang->line('Fields') ?></label>
                  </div>
