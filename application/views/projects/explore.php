        ...
        <div class="card-body">
            <div class="card-block">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active show" id="active-tab" data-toggle="tab" href="#active"
                           aria-controls="active"
                           aria-expanded="true"> <i
                                    class="fa fa-th-list"></i> <?php echo $this->lang->line('Summary') ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="link-tab" data-toggle="tab" href="#link"
                           aria-controls="link"
                           aria-expanded="false"><i class="fa fa-tasks"></i> <?php echo $this->lang->line('Tasks') ?>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" id="thread-tab" data-toggle="tab" href="#thread"
                           aria-controls="thread"><i
                                    class="fa fa-clipboard"></i> <?php echo $this->lang->line('Thread') ?></a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" id="milestones-tab" data-toggle="tab" href="#milestones"
                           aria-controls="milestones"><i
                                    class="fa fa-bullseye"></i> <?php echo $this->lang->line('Milestones') ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="thread-tab" data-toggle="tab" href="#activities"
                           aria-controls="activities"><i
                                    class="fa fa-random"></i> <?php echo $this->lang->line('Activities Log') ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="linkOpt-tab" data-toggle="tab" href="#files"
                           aria-controls="files"><i
                                    class="fa fa-folder-open"></i> <?php echo $this->lang->line('Files') ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="linkOpt-tab" data-toggle="tab" href="#notes"
                           aria-controls="notes"><i
                                    class="fa fa-clipboard"></i> <?php echo $this->lang->line('Notes') ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="invoices-tab" data-toggle="tab" href="#invoices"
                           aria-controls="invoices"><i
                                ...
                                <li data-block="sec" class="<?php if (!$flag) {
                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            ...
                                            <p>
                                                <small class="text-muted"><i
                                                            class="fa fa-clock-o"></i> <?php echo $row['sdate'] . ' ~ ' . $row['edate'] . '</small><a href="#" class=" float-xs-right delete-custom" data-did="2" data-object-id="' . $row['id'] . '"><i class="danger icon-trash-o"></i></a>'; ?>
                                            </p>
                                        </div>
                                        <div class="timeline-body">
                                            <p><?php echo $row['exp'];
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-1">
                                ...
                                foreach ($invoices as $item) {
                                    echo '<tr>
                                <td class="text-truncate"><a href="' . base_url() . 'invoices/view?id=' . $item['id'] . '">#' . $item['tid'] . '</a></td>
