                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="bg-grey bg-lighten-4">
                                                                    ...
                                                                    <td class="text-bold-800 text-xs-right"> <?php
                                                                        ...
                                                                        echo ' <span id="paydue">' . amountFormat($rming) . '</span></strong>';
                                                                        ?></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
...
//                                                        print_r($row);exit;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><button onclick="editPayment('<?php echo $row['id']; ?>',
                                                                            '<?php echo $row['method']; ?>',
                                                                            '<?php echo $row['date']; ?>',
                                                                            '<?php echo $row['debit']; ?>',
                                                                            '<?php echo $row['note']; ?>',
                                                                            '<?php echo $row['acid']; ?>')" id="edit_button" class="btn btn-primary btn-sm"><span class="fa fa-pencil"></span>&nbsp;Edit</button></td>
                                                        </tr>
                                                    <?php }
                                                    ?>
                                    ...
                                    jQuery.ajax({
                                        ...
                                        success: function (data) {
                                            ...
                                            obj.remove();
                                                ...
                                                <!-- part_payment_edit -->
                                                <div id="part_payment_edit" class="modal fade">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="payment" id="update_pay_form">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <div class="input-group">
                                                                                <div class="input-group-addon"><?php echo $this->config->item('currency') ?></div>
                                                                                <input type="text" class="form-control" placeholder="Total Amount" name="amount_edit"
                                                                                       id="rmpay_edit" value="<?php echo $rming ?>">
                                                                            </div>
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="input-group">
                                                                                <div class="input-group-addon"><span class="icon-calendar4"
                                                                                                                     aria-hidden="true"></span></div>
                                                                                <input type="text" class="form-control required" id="tsn_date_edit"
                                                                                       placeholder="Billing Date" name="paydate_edit"
                                                                                       value="<?php echo dateformat($this->config->item('date')); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col mb-1"><label
                                                                                for="pmethod"><?php echo $this->lang->line('Payment Method') ?></label>
                                                                            <select id="pmethod_edit" name="pmethod_edit" class="form-control mb-1">
                                                                                <option value="Cash"><?php echo $this->lang->line('Cash') ?></option>
                                                                                <option value="Card"><?php echo $this->lang->line('Card') ?></option>
                                                                                <option value="Bank">Bank</option>
                                                                            </select><label for="account"><?php echo $this->lang->line('Account') ?></label>

                                                                            <select id="account_edit" name="account_edit" class="form-control">
                                                                                <?php
                                                                                foreach ($acclist as $row) {
                                                                                    echo '<option value="' . $row['id'] . '">' . $row['holder'] . ' / ' . $row['acn'] . '</option>';
                                                                                }
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col mb-1"><label
                                                                                for="shortnote"><?php echo $this->lang->line('Note') ?></label>
                                                                            <input type="text" class="form-control"
                                                                                   name="shortnote_edit" id="shortnote_edit" placeholder="Short note"
                                                                                   value="Payment for purchase #<?php echo $invoice['tid'] ?>"></div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <input type="hidden" class="form-control "
                                                                               name="history_id" id="history_id" value="">
                                                                        <input type="hidden" class="form-control "
                                                                               name="history_id_amount" id="history_id_amount" value="">
                                                                        <input type="hidden" class="form-control required"
                                                                               name="tid" id="invoiceid" value="<?php echo $invoice['iid'] ?>">
                                                                        <button type="button" class="btn btn-default"
                                                                                data-dismiss="modal"><?php echo $this->lang->line('Close') ?></button>
                                                                        <input type="hidden" name="cid" value="<?php echo $invoice['cid'] ?>"><input type="hidden"
                                                                                                                                                     name="cname"
                                                                                                                                                     value="<?php echo $invoice['name'] ?>">
                                                                        <button type="button" class="btn btn-primary" onclick="submitPaymentUpdate()"
                                                                                >Update</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                        ...
                                        <script type="text/javascript">
                                            function editPayment(id, method, date, debit, note, account) {
                                                $("#tsn_date_edit").val(date);
                                                $("#pmethod_edit").val(method);
                                                $("#rmpay_edit").val(debit);
                                                $("#history_id_amount").val(debit);
                                                $("#account_edit").val(account);
                                                $("#history_id").val(id);
                                                $("#shortnote_edit").val(note);
                                                $('#part_payment_edit').modal('show');
                                            }
                                            function  submitPaymentUpdate() {
                                                var form = $("#update_pay_form");
                                                $.ajax({
                                                    url: "<?php echo base_url('transactions/updatepurchase') ?>",
                                                    type: "POST",
