                ...
                <form method="post" id="data_form">
                    ...
                    <div id="saman-row">
                        <table class="table-responsive tfr my_stripe">
                           ...
                           <tr class="sub_c" style="display: table-r<td colspan="2"><?php echo $this->lang->line('Payment Terms') ?> <select name="pterms"                                                                                                         class="selectpicker form-control"><?php foreach ($terms as $row) {
                                            echo '<option value="' . $row['id'] . '">' . $row['title'] . '</option>';
                                        } ?>
